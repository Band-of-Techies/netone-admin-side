...
class _NetoneStatusSectionState extends State<NetoneStatusSection> {
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return AgentRequestItem(
                            ...
                            agent: loanRequests![index].salesAgent.name!,
  ...
  void fetchData() async {
    ...
    try {
      String apiEndpoint = '$endpoint/loan_requests?filter=netone';
      if (search.text.isNotEmpty) {
        apiEndpoint =
            '$endpoint/loan_requests?filter=netone&search=${search.text}';
      }
